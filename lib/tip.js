...
export default config => {
  config = {
    xLine: false,
    yLine: false,
    renderer: (x, y) => // TODO: template string!
  ...
  //     const innerSelection = selection.selectAll('g.tip')
  //       .data(d => [d])
  //       // enter
  //     innerSelection
  //       .enter().append('g')
  ...
  //     // enter + update = enter inner tip
  //     this.el = innerSelection.selectAll('g.inner-tip')
  //       .data(d => [d])
  ...
  //     const el = this.el //TODO: what?
  //     const inf = 1e8
  //     const meta = config.owner.meta
  //     const data = el.data()[0].data
